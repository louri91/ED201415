...
{
public:
    typedef pair<clave,definicion> pepe;
    int size_type;

    typedef pair<clave, definicion> entrada;
    
    
	/** @brief constructor primitivo. 
	@post define la entrada nula como el par ("",-1)
	*/
    diccionario<clave,definicion>();

	/** @brief constructor de copia
	@param[in] d diccionario a copiar
	*/
    diccionario<clave,definicion>(const diccionario<clave, definicion> & d);
	...
	*/
    ...
    pair<entrada,bool>  find( const clave & s) const;
     ...
     */
    definicion & operator[](const clave & s);
    ...
    const definicion & operator[](const clave & s) const;
...
private:
	...
	vector<pair<clave,definicion>> dic; // vector que almacena los elementos del diccionario
