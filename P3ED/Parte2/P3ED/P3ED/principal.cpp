...
void load(diccionario<clave,definicion> & d, const string & s){
    string value;
    ifstream fe(s);
    ifstream configFile;
        ...
        string line;
            while(getline(configFile,line)){
                ...
                for (int sup=0;sup<line.size();sup++){
                    ...
                    pair<clave,definicion> insertar;
        
                    
                //  insertar.first=miNombre;
                //  insertar = make_pair(miNombre, miDef);
                //  insertar.second="25";
                //  insertar.second=miDef;
...
int main()
{
    ...
    double secs;
    diccionario<string, list<nombreM>> lectura;
    load(lectura, "/Users/Louri/Desktop/PRACTICASUGR/ED/P3ED/Parte2/P3ED/P3ED/meteorites_all.csv");
    diccionario<string, list<nombreM>> Meteoritos(lectura);
    pair<pair<string,list<nombreM>>, bool> meteoritoBusqueda;
    t_inicio=clock();
